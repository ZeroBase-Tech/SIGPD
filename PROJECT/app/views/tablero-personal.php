...
<body class="bg-dark">
  ...
  <div class="container d-flex flex-column justify-content-center align-items-center text-center py-3">
    <a href="index.php?ruta=Start" class="text-decoration-none">
      <h1 class="blinker-semibold" style="position: relative; top: 40px;">DraftoTux</h1>
    </a>
    <div class="barra_puntos row mx-2" style="position: relative; right: 340px; top: 100px;">
      <h4 class="mb-0 text-white">Puntos: <span class="puntos">0</span></h4>
    </div>
    <div class="tablero">
      <div class="tablero-usuario"><?= htmlspecialchars($nombre_jugador) ?></div>
    ...
    <div class="barra_dado py-3 mx-2" style="position: relative; left: 330px; top: 35px;">
      <div class="form-check form-switch pb-2">
        ...
        <label class="fs-5 form-check-label text-white" for="switchOnOff"
          style="position: relative; left: -5px; top: -4px;">Turno</label>
      </div>
      <div class="btn-group-vertical" role="group" aria-label="Seleccionar dado">
        ...
        <label class="btn btn-outline-success p-1" for="dado-arch">
          <img src="assets/img/DadoArch.png" class="dado img-fluid">
        </label>
        ...
        <label class="btn btn-outline-success p-1" for="dado-vacio">
          <img src="assets/img/DadoVacio.png" class="dado img-fluid">
        </label>
        ...
        <label class="btn btn-outline-success p-1" for="dado-verde">
          <img src="assets/img/DadoVerde.png" class="dado img-fluid">
        </label>
        ...
        <label class="btn btn-outline-success p-1" for="dado-gris">
          <img src="assets/img/DadoGris.png" class="dado img-fluid">
        </label>
        ...
        <label class="btn btn-outline-success p-1" for="dado-terminal">
          <img src="assets/img/DadoTerminal.png" class="dado img-fluid">
        </label>
        ...
        <label class="btn btn-outline-success p-1" for="dado-cafe">
          <img src="assets/img/DadoCafe.png" class="dado img-fluid">
        </label>
      </div>
    </div>
    ...
    <div class="row d-flex justify-content-center mt-5 mb-3">
      <div class="col-5">
        <a href="index.php?ruta=Boards" class="btn btn-success  fs-5">
          Atrás
        </a>
      </div>

      <div class="col-5">
        <form method="post" action="index.php?ruta=FinalizarPartida">
          <input type="hidden" name="id_tablero" value="<?= htmlspecialchars($id_tablero) ?>">
          <input type="hidden" name="puntos" id="puntosInput" value="0">
