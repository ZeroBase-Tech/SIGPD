...
<body class="bg-dark">
	...
	<div class="barra_puntos row mx-2" style="position: relative; right: 330px; top: 70px;">
	 <h4 class="mb-0 text-white">Puntos: <span class="puntos">0</span></h4>
       ...
       <div class="barra_dado py-3 mx-2" style="position: relative; left: 330px; top: 35px;">
          <div class="form-check form-switch pb-2">
            ...
            <label class="fs-5 form-check-label text-white" for="switchOnOff" style="position: relative; left: -5px; top: -4px;">Turno</label>
          </div>
	...
	<div id="alert-container" class="mt-4" style="position: absolute; top:100px; z-index:9999; min-width: 250px;"></div>
    </div>
